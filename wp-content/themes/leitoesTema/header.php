    ...
    <nav class="border-gray-200 bg-white px-4 py-2.5 dark:bg-gray-800 lg:px-6">
        <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
            <div class="flex items-center">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/iconGeeon.svg" class="mr-3 h-6 sm:h-9" alt="GEEON Logo" />
            ...
            <div class="hidden w-full items-center justify-between lg:order-1 lg:flex lg:w-auto" id="mobile-menu-2">
                <ul class="mt-4 flex flex-col font-medium lg:mt-0 lg:flex-row lg:space-x-8">
                    <li>
                        <a
                                href="#"
                                class="block border-b border-gray-100 py-2 pr-4 pl-3 text-primary-600 hover:bg-gray-50 dark:border-gray-700 dark:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-primary-500 lg:border-0 lg:p-0 lg:hover:bg-transparent lg:hover:text-primary-600 lg:dark:hover:bg-transparent lg:dark:hover:text-primary-500"
                                aria-current="page"
                        >
                            Home
                        </a>
                    ...
                    <li>
                        <a
                                href="#"
                                class="block border-b border-gray-100 py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white lg:border-0 lg:p-0 lg:hover:bg-transparent lg:hover:text-primary-600 lg:dark:hover:bg-transparent lg:dark:hover:text-primary-500"
                        >
                            Atendimentos
                        </a>
                    </li>
                    ...
                    <li>
                        <button
                                ...
                                class="flex w-full items-center justify-between border-b border-gray-100 py-2 pr-4 pl-3 font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white lg:w-auto lg:border-0 lg:p-0 lg:hover:bg-transparent lg:hover:text-primary-600 lg:dark:hover:bg-transparent lg:dark:hover:text-primary-500"
                        >
                            Sobre nós
                            <svg class="ml-1 h-5 w-5 lg:h-4 lg:w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                                        fill-rule="evenodd"
                        ...
                        <div
                                id="mega-menu"
                                class="absolute z-10 grid hidden w-full border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-700 lg:w-auto lg:grid-cols-3 lg:rounded-lg"
                        >
                            <div class="bg-white p-2 text-gray-900 dark:bg-gray-800 dark:text-white lg:col-span-2 lg:rounded-lg">
                                <ul>
                                    <li>
                                        <a href="#" class="flex items-center rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            <div class="mr-4 rounded-lg bg-white p-2 shadow dark:bg-gray-700">
                                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
                                                </svg>
                                            </div>
                                            <div>
                                                <div class="font-semibold">Nossa missão</div>
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <div>
                                                <div class="font-semibold">Nossa equipe</div>
                            ...
                            <div class="bg-gray-50 py-5 px-5 dark:bg-gray-700 lg:col-span-1 lg:rounded-lg">
